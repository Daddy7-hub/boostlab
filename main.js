...
(function() {
    ...
    var portfolioTranslations = {
        en: {
            ...
            'cs3.desc': 'Lead generation workspace with around 1M companies for finding Baltic business contacts, filtering market data and preparing targeted outreach or advertising campaigns.',
            'cs3.f1': 'Around 1M companies in the database',
        ...
        et: {
            ...
            'cs3.desc': 'Müügivihjete tööruum ligikaudu 1M ettevõttega Balti ärikontaktide leidmiseks, turuandmete filtreerimiseks ning sihitud outreachi või reklaamikampaaniate ettevalmistamiseks.',
            'cs3.f1': 'Andmebaasis ligikaudu 1M ettevõtet',
        ...
        ru: {
            ...
            'cs3.desc': 'Рабочая платформа с базой около 1 млн компаний для поиска бизнес-контактов в Балтии, фильтрации рыночных данных и подготовки точечных outreach- или рекламных кампаний.',
            'cs3.f1': 'Около 1 млн компаний в базе',
        ...
        lt: {
            ...
            'cs3.desc': 'Lead generavimo darbo erdvė su maždaug 1M įmonių Baltijos verslo kontaktams rasti, rinkos duomenims filtruoti ir tikslinėms outreach arba reklamos kampanijoms paruošti.',
            'cs3.f1': 'Duomenų bazėje apie 1M įmonių',
        ...
        lv: {
            ...
            'cs3.title': 'BalticLeads — lead platforma',
            'cs3.desc': 'Lead ģenerēšanas darba vide ar aptuveni 1M uzņēmumu Baltijas biznesa kontaktu atrašanai, tirgus datu filtrēšanai un mērķētām outreach vai reklāmas kampaņām.',
            'cs3.f1': 'Datubāzē aptuveni 1M uzņēmumu',
        ...
        es: {
            ...
            'cs3.desc': 'Espacio de trabajo de generación de leads con alrededor de 1M de empresas para encontrar contactos en los Bálticos, filtrar datos de mercado y preparar campañas publicitarias o de outreach.',
            'cs3.f1': 'Alrededor de 1M de empresas en la base',
        ...
        fr: {
            ...
            'cs3.desc': 'Espace de travail de génération de leads avec environ 1M d’entreprises pour trouver des contacts business dans les pays baltes, filtrer les données marché et préparer des campagnes ciblées.',
            'cs3.f1': 'Environ 1M d’entreprises dans la base',
